...
m.montecarlo = false;
    ...
    m.popStructGiven = m.readinPopstruct('./simulate_results_N10000_sametox1_processed');
...
%save workspace
save([m.outputsdir 'simulate_results' '_N' num2str(m.simulateN) '_sametox' num2str(m.sametox) '_subpopOnly' num2str(m.changeToSubpopOnly)], 'm');
