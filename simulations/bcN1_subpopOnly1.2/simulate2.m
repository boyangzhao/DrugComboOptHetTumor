...
m.montecarlo = false;
    ...
    m.popStructGiven = m.readinPopstruct('./simulate_results_sametox1_subpopOnly0_combined_processed');
...
%save workspace
save([m.outputsdir 'simulate_results' '_sametox' num2str(m.sametox) '_subpopOnly' num2str(m.changeToSubpopOnly)], 'm');
